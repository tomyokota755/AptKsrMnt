...
# 各空港のコリドー判定基準（エリアを大幅に拡大：5分間隔でも逃さない設定）
AREAS = {
    "新千歳": [
        {"range": [42.40, 42.75, 141.55, 141.95], "msg": "新千歳01L、01R"},
        {"range": [42.85, 43.20, 141.60, 142.00], "msg": "新千歳19L、19R"}
    ],
    "成田": [
        {"range": [35.40, 35.75, 140.35, 140.75], "msg": "成田34L、34R"},
        {"range": [35.80, 36.15, 140.05, 140.45], "msg": "成田16L、16R"}
    ],
    "羽田": [
    ...
    "中部": [
        {"range": [34.60, 34.85, 136.70, 136.95], "msg": "中部36"},
        {"range": [34.90, 35.15, 136.70, 136.95], "msg": "中部18"}
    ],
    "関空": [
        {"range": [34.15, 34.45, 135.00, 135.35], "msg": "関空06L、06R"},
        {"range": [34.40, 34.70, 135.30, 135.65], "msg": "関空24L、24R"}
    ],
    "福岡": [
        {"range": [33.35, 33.58, 130.40, 130.65], "msg": "福岡34"},
        {"range": [33.62, 33.85, 130.30, 130.55], "msg": "福岡16"}
    ],
    "那覇": [
        {"range": [25.95, 26.18, 127.55, 127.75], "msg": "那覇36L、36R"},
        {"range": [26.22, 26.45, 127.60, 127.85], "msg": "那覇18L、18R"}
    ]
}
